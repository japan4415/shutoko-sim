...
pub use inventory::{
    ...
    ramps_artifact_to_deterministic_json, tariff_overrides_from_catalog,
    ...
    validate_verified_billing_pair_endpoints, CanonicalRampInventoryItem, DistanceEvidenceV3,
...
pub use billing::{
    ...
    PairDerivationPromotionDecision, PairDerivationRelationCoverageSummary,
    PairDerivationRelationManifest, PairDerivationReport, PairDerivationRouteRole,
    PairDerivationSummary, RadialRoutePlanGeneration, RejectedSeedRecord,
...
pub use route_membership::{
    all_route_relation_ids, bound_ramp_evidence_from_inventory, build_bound_ramp_memberships,
    build_relation_memberships, build_route_membership_indices,
    build_route_membership_indices_with_coverage, build_route_memberships,
    build_route_relation_coverage, default_route_relation_ids, find_first_exit_on_corridor,
    ...
    validate_resolved_route_plan, validate_resolved_route_plan_segments,
    validate_route_membership_structure, validate_route_memberships, validate_route_plan_segments,
    BoundRampEvidence, CorridorExit, CorridorFirstExitResolution, DirectedRoutePlanResolution,
    GraphSchemaV4, GraphSchemaV4BillingPair, ResolvedRouteSegment, RouteMembershipBuildOptions,
    RouteMembershipCoverage, RouteMembershipError, RouteMembershipIndex, RouteMembershipSegment,
    RouteMembershipSourceKind, RoutePlanLapV1, RoutePlanSegmentRole, RouteRelationCoverage,
    RouteRelationCoverageReport, RouteRelationCoverageStatus, RouteRelationMembershipBuild,
